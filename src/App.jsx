...
const BANK = [
  ...
  // ---- Country/city with the most ___ per capita ----
  { prompt: "Which country has the most Nobel laureates per capita in the world?", options: ["Saint Lucia", "Sweden", "Iceland", "Switzerland"], answer: 0, fact: "Saint Lucia's two laureates, Derek Walcott and Arthur Lewis, give it about 10.8 per million people, the highest rate of any sovereign state." },
  { prompt: "Which country had the highest number of billionaires per capita in 2025?", options: ["Monaco", "Switzerland", "Luxembourg", "Singapore"], answer: 0, fact: "Monaco's tiny population and wealthy residents give it about 77 billionaires per million people, per Forbes-based rankings." },
  { prompt: "Which country is often cited as having the largest police force per capita in the world?", options: ["Monaco", "Singapore", "Vatican City", "Qatar"], answer: 0, fact: "Monaco reportedly fields around 515 officers for roughly 35,000 residents." },
  { prompt: "Which country has the highest rate of civilian firearm ownership per capita?", options: ["United States", "Yemen", "Switzerland", "Serbia"], answer: 0, fact: "A 2018 survey estimated about 120 firearms per 100 US residents, more guns than people." },
  { prompt: "Which country is considered the world's sauna capital per capita?", options: ["Finland", "Sweden", "Norway", "Estonia"], answer: 0, fact: "Finland has an estimated 3.3 million saunas for 5.6 million people, roughly one per 1.7 residents." },
  { prompt: "Which country has Europe's highest museum density per capita?", options: ["Andorra", "Iceland", "Luxembourg", "San Marino"], answer: 0, fact: "Andorra counts about 325 museums per million residents, per UNESCO-based data." },
  { prompt: "Which country has led the world in beer consumption per capita for over 30 years running?", options: ["Czechia", "Germany", "Ireland", "Austria"], answer: 0, fact: "Czechs drank about 152 liters of beer per person in 2023, extending a streak stretching back to 1993." },
  { prompt: "Which country has the most published writers per capita in the world?", options: ["Iceland", "Ireland", "Norway", "Finland"], answer: 0, fact: "Roughly 1 in 10 Icelanders has published a book, according to Guinness World Records." },
  { prompt: "Which city ranked first globally for bars, pubs, and clubs per capita in a 2022 comparison?", options: ["Prague", "Las Vegas", "Dublin", "Munich"], answer: 0, fact: "The ranking counted about 48 nightlife venues per 100,000 residents in Prague, ahead of Las Vegas and Orlando." },
  { prompt: "Which country had the most golf courses per capita among countries with over 500,000 people?", options: ["Scotland", "New Zealand", "Ireland", "Australia"], answer: 0, fact: "Scotland had about one golf course per 9,379 people, ahead of New Zealand and Australia." },
  { prompt: "Which EU country has the highest number of beekeepers per capita?", options: ["Slovenia", "Poland", "Romania", "Greece"], answer: 0, fact: "Slovenia counted over 11,000 beekeepers in 2020, about 5 per 1,000 residents." },
  { prompt: "Which territory is believed to have the world's highest road-tunnel density per person?", options: ["Faroe Islands", "Norway", "Iceland", "Switzerland"], answer: 0, fact: "Including a planned tunnel, the Faroe Islands could reach nearly 2 meters of road tunnel per resident." },
  { prompt: "Which country had Europe's most billion-dollar startups (\"unicorns\") per capita in 2024?", options: ["Estonia", "Sweden", "Netherlands", "Ireland"], answer: 0, fact: "Estonia, with about 1.3 million people, had produced 10 unicorn startups by 2024." },
  { prompt: "Which country has the world's highest electric vehicle ownership per capita?", options: ["Norway", "Netherlands", "Iceland", "Sweden"], answer: 0, fact: "By 2024, EVs made up 28% of Norway's passenger-car fleet and 88% of new car sales." },
  { prompt: "Which city had the most Michelin-starred restaurants per capita among major cities in 2024?", options: ["Kyoto", "Paris", "Tokyo", "Osaka"], answer: 0, fact: "Kyoto had about 100 Michelin restaurants, roughly one per 14,600 residents." },
  { prompt: "Which country has the highest density of medical doctors per capita, per WHO-based data?", options: ["Cuba", "Monaco", "Austria", "Norway"], answer: 0, fact: "Cuba reported about 95 doctors per 10,000 people in the most recent WHO-derived figures." },
  { prompt: "Which U.S. city has the most craft breweries per capita?", options: ["Portland, Maine", "Asheville", "Denver", "Portland, Oregon"], answer: 0, fact: "Portland, Maine had about 18 breweries per 50,000 residents in a 2024 ranking of over 500 US cities." },
  { prompt: "Which city ranked first for bookstores per capita in a 2021 comparison?", options: ["Lisbon", "Buenos Aires", "Melbourne", "Paris"], answer: 0, fact: "Lisbon had about 42 bookstores per 100,000 residents in that comparison, though older rankings had put Buenos Aires first." },
  { prompt: "Which country topped a global comparison of libraries per capita?", options: ["Slovakia", "Finland", "Palau", "Estonia"], answer: 0, fact: "Slovakia registered about 138 libraries per 100,000 residents, ahead of Palau and Finland in that analysis." },
  { prompt: "Which country claims the highest number of castles and ch\u00e2teaux per capita in the world?", options: ["Slovakia", "Czechia", "Scotland", "France"], answer: 0, fact: "Slovakia counts over 180 castles and 425 ch\u00e2teaux across a population of about 5.4 million." },

  // ---- Obscure or surprising geography facts ----
  { prompt: "Which pair of towns forms a patchwork of about 30 Belgian and Dutch enclaves within each other?", options: ["Baarle-Hertog and Baarle-Nassau", "B\u00fcsingen and Schaffhausen", "Ll\u00edvia and Puigcerd\u00e0", "Jungholz and Sorgschrofen"], answer: 0, fact: "Baarle contains roughly half the enclaves in the world, 22 Belgian and 8 Dutch, with borders formalized in 1995." },
  { prompt: "Which two islands, just 4 km apart, are split by both an international border and the date line?", options: ["The Diomede Islands", "The Faroe Islands", "Pheasant Island", "Hans Island"], answer: 0, fact: "Big Diomede belongs to Russia and Little Diomede to Alaska, separated by the US-Russia line and the International Date Line." },
  { prompt: "Which land area between Egypt and Sudan is claimed by neither country?", options: ["Bir Tawil", "Hala'ib Triangle", "Jungholz", "Neutral Moresnet"], answer: 0, fact: "Each country's preferred border line assigns the more valuable Hala'ib Triangle to itself, leaving the less valuable Bir Tawil unclaimed by either." },
  { prompt: "Which small island did Canada and Denmark split in 2022, giving the two countries a shared land border?", options: ["Hans Island", "Bouvet Island", "M\u00e4rket", "Pheasant Island"], answer: 0, fact: "The 2022 agreement ended the decades-long, good-natured \u201cWhisky War\u201d between Canada and Denmark." },
  { prompt: "Which uninhabited island switches sovereignty between two countries every six months?", options: ["Pheasant Island", "Hans Island", "M\u00e4rket", "Campione d'Italia"], answer: 0, fact: "France and Spain have alternated control of this island in the Bidasoa River for centuries." },
  { prompt: "Which Austrian village is reachable by road only through Germany, touching the rest of Austria at a single mountain point?", options: ["Jungholz", "B\u00fcsingen", "Ll\u00edvia", "Campione d'Italia"], answer: 0, fact: "Jungholz meets the rest of Austria only at a point on Mount Sorgschrofen." },
  { prompt: "Which German municipality is completely surrounded by Switzerland?", options: ["B\u00fcsingen am Hochrhein", "Jungholz", "Campione d'Italia", "Melilla"], answer: 0, fact: "Reaching B\u00fcsingen from the rest of Germany by road means crossing about 750 meters of Swiss territory." },
  { prompt: "Which Italian exclave sits entirely inside Switzerland?", options: ["Campione d'Italia", "B\u00fcsingen", "Ll\u00edvia", "Point Roberts"], answer: 0, fact: "Campione d'Italia's customs status had to be renegotiated when it joined the EU customs area in 2020." },
  { prompt: "Which settlement is a UAE \u201ccounter-enclave\u201d nested inside an Omani enclave that is itself surrounded by the UAE?", options: ["Nahwa", "Madha", "Melilla", "B\u00fcsingen"], answer: 0, fact: "Nahwa creates a rare \u201cRussian doll\u201d border arrangement in the Hajar Mountains." },
  { prompt: "Which Spanish town ended up stranded inside France due to a treaty dispute over the word \u201cvillage\u201d?", options: ["Ll\u00edvia", "Melilla", "Jungholz", "Baarle-Hertog"], answer: 0, fact: "The 1659 Treaty of the Pyrenees ceded \u201cvillages\u201d to France, but Spain argued Ll\u00edvia was legally a town, not a village." },
  { prompt: "Which Norwegian territory lets foreign visitors travel without a standard immigration visa, under a special treaty?", options: ["Svalbard", "Bouvet Island", "Jan Mayen", "the Faroe Islands"], answer: 0, fact: "Norway's ordinary Immigration Act doesn't apply on Svalbard, though visitors may still need a Schengen visa to transit mainland Norway." },
  { prompt: "Which island is considered the most remote in the world, over 1,600 km from its nearest land (Antarctica)?", options: ["Bouvet Island", "Tristan da Cunha", "Easter Island", "Pitcairn Island"], answer: 0, fact: "This uninhabited Norwegian dependency sits alone in the South Atlantic." },
  { prompt: "Which self-governing monastic community has banned women from entering for over a thousand years?", options: ["Mount Athos", "Vatican City", "San Marino", "Andorra"], answer: 0, fact: "Mount Athos is an autonomous, all-male region within Greece, home to 20 monasteries." },
  { prompt: "Which U.S. town can only be reached overland from the rest of the country by driving through Canada?", options: ["Point Roberts, Washington", "Northwest Angle, Minnesota", "Angle Inlet, Michigan", "Elm Point, Alaska"], answer: 0, fact: "The 49th parallel border cut off the tip of a peninsula, leaving Point Roberts accessible by land only through British Columbia." },
  { prompt: "In 2015, roughly how many land enclaves did India and Bangladesh eliminate in a historic border exchange?", options: ["162", "30", "500", "12"], answer: 0, fact: "111 former Indian enclaves transferred to Bangladesh and 51 former Bangladeshi enclaves transferred to India under the Land Boundary Agreement." },
  { prompt: "Which 12 sq km Spanish exclave sits on Morocco's northern coast?", options: ["Melilla", "Ceuta", "Gibraltar", "Andorra"], answer: 0, fact: "Melilla is a Spanish autonomous city, military base, and free port in North Africa." },
  { prompt: "Which library and opera house was deliberately built straddling the US-Canada border?", options: ["Haskell Free Library and Opera House", "Point Roberts Library", "Baarle Public Library", "Niagara Falls Library"], answer: 0, fact: "Its front door sits in Vermont while its book stacks and circulation desk sit across the line in Qu\u00e9bec." },
  { prompt: "Which tiny territory was jointly administered by Belgium and Prussia from 1816 until being absorbed into Belgium in 1920?", options: ["Neutral Moresnet", "Baarle", "Jungholz", "B\u00fcsingen"], answer: 0, fact: "The 3.5 sq km territory was created after a dispute over a valuable zinc mine." },
  { prompt: "Which sovereign entity has no territory of its own but still issues diplomatic passports and maintains relations with over 100 states?", options: ["The Sovereign Order of Malta", "Vatican City", "San Marino", "Andorra"], answer: 0, fact: "The Order of Malta has about 500 diplomatic passports in circulation despite holding no sovereign land today." },
  { prompt: "Which tiny Baltic island had its Finland-Sweden border redrawn into a zigzag to fix a lighthouse built on the wrong side?", options: ["M\u00e4rket", "Bouvet Island", "Pheasant Island", "Hans Island"], answer: 0, fact: "A Finnish-built lighthouse ended up on the Swedish side in 1885; the 1985 boundary adjustment corrected it without any net land transfer." },
];
